...
\tab Before training can be done let us first look at the computational graphs of the model.
\begin{figure}[H]
	\centering
...
\begin{figure}[H]
	...
	\caption{Cost functions graph (using $\alpha = 0.001$)}
	\label{fig:cc001}
\end{figure}
As you can see from the cost function above, it reaches equilibrium around 240 epochs at a minimum cost of just under 3.0.
\section{Conclusion}
